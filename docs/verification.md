...
验证版本：Windows x64 0.3.0。内置 Node.js 24.20.0、DeepSeek Harness/SDK 0.1.2-alpha.5。
...
- Windows 安装包构建与实际安装到 `D:\deepseekharness\HarnessDesktop-App-v030` 通过。`tests/native-smoke.mjs` 从安装目录启动，使用独立数据和内置运行环境，验证首页连续执行、模型获取与切换、色盘保存、项目导航、Git 差异及正常关闭。
