...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <div className="session-list-wrapper"><React.Suspense fallback={null}><SessionSidebar onSelect={(id) => { setCurrentSessionId(id); setPage('首页'); setWorkspaceMode('work'); try { localStorage.setItem('harness-current-session', id); } catch {} }} /></React.Suspense></div>
